...
import javax.swing.*;
import java.awt.*;
public class DataModificationPanel extends JPanel{
    ...
    public DataModificationPanel() {
        ...
        JLabel titleLabel = new JLabel("修改信息");
        ...
        JButton updateResultButton = new JButton("修改");
...
//        studentClassIdField.setText(student.getClassId()+"");
        ...
        queryResultButton.setBounds(570,150,180,30);
        updateResultButton.setBounds(400, 300, 200, 30);
        ...
        updateResultButton.addActionListener(e -> updateActionPerformed());
    }

    private void updateActionPerformed() {

        student = new Student(studentIdField.getText(),studentNameField.getText(),studentGenderField.getText(),studentEthnicityField.getText(),Integer.parseInt(studentClassIdField.getText()));
        StudentDAOImpl studentDAO = new StudentDAOImpl();

        if (studentDAO.updateStudent(student)) {
            JOptionPane.showMessageDialog(this, "修改成功");
        } else {
            JOptionPane.showMessageDialog(this, "修改失败，请检查学号是否于User关联", "学生信息修改", JOptionPane.ERROR_MESSAGE);
        }
    }
