...
public class DataDeletionPanel extends JPanel{
    ...
    public DataDeletionPanel () {
        ...
        JLabel titleLabel = new JLabel("删除信息");
        ...
        JButton deleteResultButton = new JButton("删除");
...
//        studentClassIdField.setText(student.getClassId()+"");
        ...
        deleteResultButton.setBounds(400, 300, 200, 30);
        ...
        deleteResultButton.addActionListener(e -> deleteActionPerformed());
    }
    private void deleteActionPerformed() {
        ...
        if (studentDAO.deleteStudentbyID(Integer.parseInt(studentId))) {
            JOptionPane.showMessageDialog(this, "删除成功");
        } else {
            JOptionPane.showMessageDialog(this, "删除失败，请检查学号是否于User关联", "学生信息删除", JOptionPane.ERROR_MESSAGE);
        }
    }
